...
export async function syncWorldCupMatches() {
  ...
  const matchRows = mapped.map((m) => {
    ...
    return {
      ...
      homeScoreRegular: m.homeScoreRegular,
      awayScoreRegular: m.awayScoreRegular,
  ...
  await db
    ...
    .onConflictDoUpdate({
      ...
      set: {
        ...
        homeScoreRegular: sql`excluded.home_score_regular`,
        awayScoreRegular: sql`excluded.away_score_regular`,
